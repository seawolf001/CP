...
/*
 Combines two concepts.
    1) Topological ordering for mainting order of courses
    2) Cycle detection for determining if it is possible to finish all courses given the prerequisites condition
 */
